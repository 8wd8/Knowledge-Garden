...
lastEditedAt: 2023-10-25T02:53:39Z
updatedAt: 2023-10-25T02:53:39Z
authors: [shenweiyan]
categories: 
  - 好玩
labels: []
...
截止 2023.10.25 了解到飞书目前是没有 wiki 知识库内容的 API 接口，不清楚后面是否会有这方面的支持，且持续关注中。除此以外，我们也可以考虑通过第三方的工具，如 [Feishu Pages](https://github.com/longbridgeapp/feishu-pages#feishu-pages) 实现 wiki 知识库的内容导出。
